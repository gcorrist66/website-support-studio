...
export const SAMPLE_BUSINESSES: SampleBusiness[] = [
  ...
  },
  {
    ...
    badge: "Sample Business",
    tagline: "Heating, cooling, tune-ups, repairs, and seasonal system checks.",
    headline: "Comfort service for homes that cannot wait.",
    description: "A service-first HVAC website with repair urgency, tune-up packages, and clear contact paths for homeowners.",
    ...
    hours: ["Monday-Friday 7:30am-6pm", "Saturday 8am-2pm", "Priority repair requests by phone"],
    ...
    dark: "#0f2437",
    soft: "#eaf6fb",
    nav: nav("/templates/sample/northstar-air", "Services", "Work"),
    servicesLabel: "HVAC services",
    servicesIntro: "HVAC prospects need to quickly self-identify: repair, tune-up, replacement, or indoor air issue.",
    services: [
      { name: "AC Repair", meta: "Cooling diagnostics", body: "Troubleshooting for warm air, short cycling, thermostat issues, and poor airflow." },
      { name: "Furnace Repair", meta: "Heating checks", body: "No-heat calls, ignition issues, blower problems, and safety-first repair recommendations." },
      { name: "Seasonal Tune-Ups", meta: "Spring and fall", body: "Cleaning, inspection, and performance checks before heavy heating or cooling months." },
      { name: "System Replacement", meta: "Right-sized options", body: "Planning support for aging systems, efficiency questions, and comfort goals." },
      { name: "Indoor Air Quality", meta: "Filters and humidity", body: "Filter, humidity, and airflow recommendations for more comfortable rooms." },
      { name: "Thermostats", meta: "Smart controls", body: "Smart thermostat setup, schedule cleanup, and basic comfort automation." },
    ],
    proofLabel: "Service scenarios",
    proofIntro: "A strong HVAC site shows service situations, not vague promises.",
    proofItems: ["No-cool diagnostic", "Fall furnace tune-up", "Smart thermostat install", "Airflow complaint", "Filter upgrade", "Replacement consult"],
    aboutHeadline: "A practical HVAC sample built around urgent contact.",
    aboutBody: "Northstar Air is a fictional HVAC sample that makes repair categories, hours, service area, and appointment paths obvious on mobile.",
    trust: ["Emergency-style service clarity", "Heating and cooling categories", "Phone-forward CTAs", "No fake customer stories"],
    contactPrompt: "Tell Northstar what system you have, what changed, and whether heating or cooling is currently out.",
  },
  {
