...
export const FAQ_GROUPS: FaqGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How do I get started?", a: "Choose Operations or Growth and check out securely. You'll create your account and complete a short onboarding right after payment. For Enterprise, contact us and we'll scope custom capacity and onboarding." },
